...
export const DailyLeaderboard: React.FC<DailyLeaderboardProps> = ({ type, onPlayerClick }) => {
  // Empty leaderboard with placeholder message
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center space-x-2">
          ...
          <span>{type === 'daily' ? 'Daily' : 'All-Time'} Leaderboard</span>
        </CardTitle>
      </CardHeader>
      <CardContent>
